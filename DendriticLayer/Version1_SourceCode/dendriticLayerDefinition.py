...
This file defines a Keras layer that implements a dendritically inspired fully connected layer. Each neuron has several 'dendrites' that have their own summation and activation functions that are evaluated prior to the standard sum and sigmoid output. 

For a complete definition and explanation of the layer see the document "HonorsThesisProspectus.pdf" on my github in the Dendritic Layer folder of the Corgraph Project repository. 
...
class dendriticLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel = self.add_weight(shape=(dendrites ,input_dim, self.units),
